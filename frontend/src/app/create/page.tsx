        ...
        <div className="space-y-8">
          ...
          <FadeIn delay={0.1}>
            <div className="text-center">
              <div className="inline-flex p-5 bg-gradient-to-br from-primary-500 via-blue-600 to-purple-600 rounded-3xl shadow-2xl mb-6 animate-float">
                <Sparkles className="w-12 h-12 text-white" />
              </div>
              <h1 className="text-5xl font-extrabold bg-gradient-to-r from-primary-600 via-blue-600 to-purple-600 bg-clip-text text-transparent dark:from-primary-400 dark:via-blue-400 dark:to-purple-400 mb-4">
