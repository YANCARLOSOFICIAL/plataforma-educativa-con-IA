          ...
          <div className="px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex-1 max-w-2xl">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 rounded-xl glass-strong border-0 focus:ring-2 focus:ring-primary-500 transition-all text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                  />
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 ml-4">
                <button className="relative p-3 hover:bg-white/50 dark:hover:bg-gray-700/50 rounded-xl transition-all group">
