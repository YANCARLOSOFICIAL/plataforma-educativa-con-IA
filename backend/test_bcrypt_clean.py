...
try:
    ...
    print("   [OK] Truncamiento funciona")
except Exception as e:
    print(f"   [ERROR] Error: {e}")
    sys.exit(1)
...
try:
    ...
    print("   [OK] Hash generado correctamente")
except Exception as e:
    print(f"   [ERROR] Error: {e}")
...
try:
    ...
    if not is_valid:
        print("   [OK] Rechazó contraseña incorrecta (correcto)")
    else:
        print("   [ERROR] Aceptó contraseña incorrecta (incorrecto)")
        sys.exit(1)
except Exception as e:
    print(f"   [ERROR] Error: {e}")
    sys.exit(1)
...
try:
    ...
    if is_valid:
        print("   [OK] Contraseña larga manejada correctamente")
    else:
        print("   [ERROR] Falló con contraseña larga")
        sys.exit(1)
except Exception as e:
    print(f"   [ERROR] Error: {e}")
    import traceback
